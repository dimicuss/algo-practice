...
Если же такого узла не нашлось (mostRightLeftNode) то за место удалемого ставим его левый узел с
...
Так как функция рекурсивная то понадобится память под стэк вызовов равный уровню дерева на котором находтся удаляемый элемент, то есть O(log(n))
