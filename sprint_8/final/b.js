...
/*
  ...
  Бор будет весить O(E^l), где E мощность алфавита, а l максимальная длинна слова в словаре.
  Дополнительно память будет занимать коллстек, пропорционально времени исполнения алгоритма, то есть максимум O(n^2) 
*/
